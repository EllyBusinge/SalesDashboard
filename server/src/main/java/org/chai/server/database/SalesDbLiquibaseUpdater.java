package org.chai.server.database;
...
public class SalesDbLiquibaseUpdater implements ResourceLoaderAware {
    ...
    private Logger log = LoggerFactory.getLogger(SalesDbLiquibaseUpdater.class);
    ...
    public void init() throws Exception {
        ...
        try {
            ...
            throw new UnexpectedException("Could not update database through Liquibase", e);
        }
    }
    ...
    class SpringFileOpener implements FileOpener {
        ...
        private String adjustClasspath(String file) {
            return isClasspathPrefixPresent(parentFile) && !isClasspathPrefixPresent(file) ? ResourceLoader.CLASSPATH_URL_PREFIX + file : file;
        }
